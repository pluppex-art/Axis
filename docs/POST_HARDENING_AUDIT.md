...
> - Migrations de 2026-09-21 no repo (todas as migrations de 2026-09-21 (`a1`, `a4`, `cr1`, `cr2`, `cr3`, `fixes_m5_m7_baixo_get_public_imovel`) estão **aplicadas** no banco vivo desde 2026-09-24 (resta 1 produto órfão, ver `docs/projeto/06-PLANO-DE-IMPLEMENTACAO.md` tarefa 1.6)) ainda pendentes de aplicação.
