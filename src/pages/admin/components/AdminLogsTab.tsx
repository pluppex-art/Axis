...
const SAMPLE_LOGS: SystemLogEntry[] = [
  {
    id: "log-1",
    timestamp: "2026-09-14 12:04:18.421",
    level: "INFO",
    service: "Database (RLS)",
    tenant: "gtech-master",
    message: "Verificação de política RLS aprovada para tenant_isolation_tenants [has_tenant_access = true]",
    traceId: "trc_99a812f",
    latencyMs: 14,
    ip: "187.19.201.44",
    details: { table: "tenants", action: "SELECT", rows: 6, executionTime: "14ms" },
  },
  {
    id: "log-2",
    timestamp: "2026-09-14 12:03:55.109",
    level: "SUCCESS",
    service: "Auth & Sessions",
    tenant: "solar-axis",
    message: "Autenticação via Supabase Auth JWT concluída com sucesso para admin@solaraxis.com.br",
    traceId: "trc_88f219b",
    latencyMs: 38,
    ip: "179.182.91.12",
    details: { userId: "usr_solar_admin", method: "password", provider: "supabase", role: "Administrador / Sócio" },
  },
  {
    id: "log-3",
    timestamp: "2026-09-14 12:02:11.890",
    level: "INFO",
    service: "Edge Webhooks",
    tenant: "e-empreenda",
    message: "Disparo de webhook de lead capturado via Landing Page entregue com HTTP 200 OK",
    traceId: "trc_77b310a",
    latencyMs: 62,
    ip: "10.0.4.19",
    details: { endpoint: "https://api.whatsapp-gateway.com/v1/send", payloadSize: "1.2KB", retries: 0 },
  },
  {
    id: "log-4",
    timestamp: "2026-09-14 11:58:34.612",
    level: "WARN",
    service: "Database (RLS)",
    tenant: "prime-imoveis",
    message: "Consulta de imóveis com alto volume de registros sem paginação explícita (limit 100 aplicado)",
    traceId: "trc_66d408c",
    latencyMs: 142,
    ip: "201.88.112.5",
    details: { query: "select * from imoveis where status = 'Disponivel'", warning: "Query sem cursor de paginação" },
  },
  {
    id: "log-5",
    timestamp: "2026-09-14 11:45:10.022",
    level: "SECURITY",
    service: "Auth & Sessions",
    tenant: "gtech-master",
    message: "Tentativa de login com senha incorreta bloqueada por rate limit preventivo",
    traceId: "trc_55e109d",
    latencyMs: 22,
    ip: "45.162.228.90",
    details: { attempts: 3, window: "60s", action: "temp_throttle" },
  },
  {
    id: "log-6",
    timestamp: "2026-09-14 11:30:00.115",
    level: "SUCCESS",
    service: "Billing SaaS",
    tenant: "clinica-vitta",
    message: "Fatura mensal de assinatura (R$ 2.497,00) confirmada via webhook Asaas/Stripe",
    traceId: "trc_44c902f",
    latencyMs: 45,
    ip: "10.0.1.1",
    details: { invoiceId: "inv_99812", method: "credit_card", status: "paid" },
  },
  {
    id: "log-7",
    timestamp: "2026-09-14 11:15:22.408",
    level: "INFO",
    service: "Modulos",
    tenant: "solar-axis",
    message: "Módulo 'solar' e 'aurora' habilitados nas preferências de tenant_modules",
    traceId: "trc_33b811a",
    latencyMs: 29,
    ip: "187.19.201.44",
    details: { updatedBy: "Master Admin", changes: { solar: true, aurora: true } },
  },
  {
    id: "log-8",
    timestamp: "2026-09-14 10:59:44.981",
    level: "INFO",
    service: "Database (RLS)",
    tenant: "gtech-master",
    message: "Rotina de limpeza de sessões expiradas finalizada. 12 sessões inativas recicladas.",
    traceId: "trc_22a704e",
    latencyMs: 18,
    ip: "127.0.0.1",
    details: { vacuum: "active", memoryFreed: "32MB" },
  }
];

export function AdminLogsTab() {
  const [logs, setLogs] = useState<SystemLogEntry[]>(SAMPLE_LOGS);
