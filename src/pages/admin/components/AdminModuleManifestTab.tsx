 ...
 *
 * Renomeado de AdminModulesTab para AdminModuleManifestTab durante o merge do origin/main
 * (2026-09-19): origin ja tinha um AdminModulesTab proprio, com um proposito diferente (toggle
 * de modulos por tenant + presets), que permanece com o nome original.
 */
export function AdminModuleManifestTab() {
